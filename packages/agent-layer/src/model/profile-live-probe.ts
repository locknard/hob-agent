import type { ProfileMetadataWriter } from "../auth/profiles/api-key-profile-provisioner.js";
...
import type { WritableSecretVault } from "../auth/secrets/macos-keychain-secret-vault.js";
